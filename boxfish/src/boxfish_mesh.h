...
//
// boxfish_mesh.h -- nmm::dcel specific for openvrml::indexed_face_set_node
//

#ifndef _boxfish_mesh_h_
#define _boxfish_mesh_h_
...
#endif /* _boxfish_mesh_h_ */

//
// boxfish_mesh.h -- end of file
//
