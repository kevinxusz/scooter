...
//
// boxfish_mesh_editor.cpp -- mesh editor widget
//
...
#include "boxfish_mesh_control.h"
...
void Editor::reload( QModelIndex index ) {
   ...
   boxfish::vrml::scene::Item *item = 
      static_cast<boxfish::vrml::scene::Item*>( object );
   ...
   m_mesh_control = new boxfish::vrml::mesh::Control( this, browser, ifs_node );
...
// 
// boxfish_mesh_editor.cpp -- end of file
//
