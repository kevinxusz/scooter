...
//
// boxfish_mesh_scene.h -- visual representation of boxfish::vrml::mesh::Mesh
//

#ifndef _boxfish_mesh_scene_h_
#define _boxfish_mesh_scene_h_
...
class Scene {
   public:
      ...
      typedef Mesh::Matrix                        Matrix;
      typedef Mesh::Point                         Point;
      typedef Mesh::Color                         Color;
      typedef Mesh::Vertex                        Vertex;
      typedef Mesh::Line                          Line;
      typedef Mesh::Segment                       Segment;
      typedef Mesh::Intersection                  Intersection;
   ...
   public:
      ...
      void reload( openvrml::browser *target_browser, 
...
typedef boost::shared_ptr<Scene> Scene_pointer;
...
#endif /* _boxfish_mesh_scene_h_ */

//
// boxfish_mesh_scene.h -- end of file
//
