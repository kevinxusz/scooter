/* jconfig.h.in.  Generated from configure.ac by autoheader.  */
...
/* Libpng is available in order to support the PNG file format. */
#undef PNG_SUPPORTED

/* cjpeg/djpeg support the PBMPLUS PPM/PGM file formats. */
#undef PPM_SUPPORTED
