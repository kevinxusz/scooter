...
// 
// cr_mesh_scene.h -- visual representation of cr::vrml::mesh::Mesh
// 

#ifndef _cr_mesh_scene_h_
#define _cr_mesh_scene_h_
...
#endif /* _cr_mesh_scene_h_ */

//
// cr_mesh_scene.h -- end of file
//
