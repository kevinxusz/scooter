...
class CrMeshControl {
   ...
   protected:
      ...
      struct Halfedge_properties {
	    ...
	    unsigned int    m_index;
	    FT              m_delta;
	    unsigned int    m_rabbit; // brotherhood id
   ...
   private:
      ...
      Color m_halfedge_color;
      Color m_boundary_color;
      Color m_rabbit_color;
      Color m_prev_color;
      Color m_next_color;
      Color m_opposite_color;
      Color m_vertex_color;
